...
addpath(genpath('/home/581/deg581/filter1'))
...
Norm_NoFlow_T_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_NoFlow_temp_yr0021-0021.nc';
Norm_NoFlow_S_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_NoFlow_salt_yr0021-0021.nc';
Norm_NoFlow_svstr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_NoFlow_svstr_yr0021-0021.nc';
Norm_NoFlow_sustr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_NoFlow_sustr_yr0021-0021.nc';
Norm_NoFlow_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_NoFlow_m_yr0021-0021.nc';

Norm_T_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_temp_yr0021-0021.nc';
Norm_S_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_salt_yr0021-0021.nc';
Norm_sustr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_sustr_yr0021-0021.nc';
Norm_svstr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_svstr_yr0021-0021.nc';
Norm_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_m_yr0021-0021.nc';

Norm_TO_T_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_TempOnly_temp_yr0021-0021.nc';
Norm_TO_S_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_TempOnly_salt_yr0021-0021.nc';
Norm_TO_sustr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_TempOnly_sustr_yr0021-0021.nc';
Norm_TO_svstr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_TempOnly_svstr_yr0021-0021.nc';
Norm_TO_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_TempOnly_m_yr0021-0021.nc';

Norm_SO_T_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_SaltOnly_temp_yr0021-0021.nc';
Norm_SO_S_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_SaltOnly_salt_yr0021-0021.nc';
Norm_SO_sustr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_SaltOnly_sustr_yr0021-0021.nc';
Norm_SO_svstr_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_SaltOnly_svstr_yr0021-0021.nc';
Norm_SO_File='/g/data/gh9/deg581/ana/tisom017_sgfw/tisom017_sgfw_Norm_SaltOnly_m_yr0021-0021.nc';
...
legend([p2s,p3s,p4s,p5s],{'no flow','with SGFW','temp only','salt only'},'location','northeast'),
legend('boxoff'),grid on,set(gca,'layer','top'),ylabel('melt rate (m/yr)',FontWeight='bold')
ntitle(' a','location','northwest','fontweight','bold','fontsize',10)
axis([20 21 7 9.5])
xticks([20:1/12:21])
...
%caxis([-10 10])
cmocean('solar')
ntitle(' b','location','northwest','fontweight','bold','fontsize',10)
title('Melt','fontsize',10,'fontweight','bold')
ylabel('with SGFW','fontsize',10,'fontweight','bold')
h_cb1=colorbar('southoutside');
axis equal
axis([2.21e6 2.35e6 -1.17e6 -9.8537e5]/1000)
grid on
set(gca,'layer','top')
set(gca,'xticklabels',[])
set(gca,'fontsize',9)
...
ntitle(' e','location','northwest','fontweight','bold','fontsize',10)
ylabel('Temperature only (% diff)','fontsize',10,'fontweight','bold')
...
caxis([-10 10])
cmocean('balance','pivot',0)
ntitle(' h','location','northwest','fontweight','bold','fontsize',10)
ylabel('Salt only (% diff)','fontsize',10,'fontweight','bold')
...
caxis([0 2.5])
cmocean('thermal')
ntitle(' c','location','northwest','fontweight','bold','fontsize',10)
title('Thermal driving','fontweight','bold','fontsize',10)
...
caxis([-10 10])
cmocean('balance','pivot',0)
ntitle(' f','location','northwest','fontweight','bold','fontsize',10)
grid on
set(gca,'layer','top')
axis equal
axis([2.21e6 2.35e6 -1.17e6 -9.8537e5]/1000)
...
caxis([-10 10])
cmocean('balance','pivot',0)
ntitle(' i','location','northwest','fontweight','bold','fontsize',10)
...
caxis([0 0.35])
cmocean('haline')
ntitle(' d','location','northwest','fontweight','bold','fontsize',10)
title('Friction velocity','fontweight','bold','fontsize',10)
...
caxis([-10 10])
cmocean('balance','pivot',0)
ntitle(' g','location','northwest','fontweight','bold','fontsize',10)
grid on
set(gca,'layer','top')
axis equal
axis([2.21e6 2.35e6 -1.17e6 -9.8537e5]/1000)
...
caxis([-10 10])
cmocean('balance','pivot',0)
ntitle(' j','location','northwest','fontweight','bold','fontsize',10)
grid on
set(gca,'layer','top')
axis equal
axis([2.21e6 2.35e6 -1.17e6 -9.8537e5]/1000)
...
title(h_cb1,'melt rate (m/yr)','fontsize',10)
title(h_cb2,'T* (\circ C)','fontsize',10)
title(h_cb3,'u* (m/s)','fontsize',10)
title(h_cb4,'%\Delta to No Flow','fontsize',10)
