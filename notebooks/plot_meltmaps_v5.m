...
caxis([-10 10]),cmocean('balance','pivot',0)
ntitle(' d','location','northwest','fontweight','bold'),ntitle('Normal','location','north'),ntitle([num2str(round((nanmean(Norm.my./NoFlow.my)-1)*100,1)),'%'],'location','northeast')
...
export_fig MeltComparison -png -transparent -m2.5
